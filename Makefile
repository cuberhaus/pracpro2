...
main.exe: cluster.o especie.o cjt_especies.o main.o cjt_clusters.o
...
cjt_clusters.o: cluster.hh cluster.cc cjt_clusters.hh cjt_clusters.cc
	g++ -c cluster.hh cluster.cc BinTree.hh cjt_clusters.hh cjt_clusters.cc $(OPCIONS)
